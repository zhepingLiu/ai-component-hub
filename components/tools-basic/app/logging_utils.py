...
_LOG_CONTEXT: contextvars.ContextVar[dict[str, Any]] = contextvars.ContextVar("tools_basic_log_context", default={})
...
def set_runtime_log_level(level: str) -> str:
    ...
    for logger_name, logger_obj in logging.root.manager.loggerDict.items():
        if isinstance(logger_obj, logging.Logger) and logger_name.startswith("tools-basic"):
